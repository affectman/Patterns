...
namespace AbstractFactory.Smartphone.Apple
{
	...
	/// </summary>
    public class AppleSmartphoneFactory : SmartphoneFactory
	{
		/// <summary>
		...
		public AppleSmartphoneFactory(string ramName, string cpuName, string batteryUnitOfMeasurement, int batteryCapacity, int ramAmount, int cpuFrequency)
		{
