...
namespace AbstractFactory.Smartphone.Samsung
{
	...
	/// </summary>
	class Samsung : SmartphoneFactory
	{
		/// <summary>
		...
		public Samsung(string ramName, string cpuName, string batteryUnitOfMeasurement, int batteryCapacity, int ramAmount, int cpuFrequency)
		{
